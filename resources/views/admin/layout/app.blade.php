...
<head>
    ...
    <title>SISGENC - Sistema de Gestão de Encomendas</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg- shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="#">
                    <img src="https://cod3cafe.tech/wp-content/uploads/2020/08/cropped-LOGO-COD3-CAFÉ-HIPSTER-2-e1596683028529.png" width="30" height="30" alt="" loading="lazy">
                    SISGENC - Sistema de Gestão de Encomendas
                </a>
