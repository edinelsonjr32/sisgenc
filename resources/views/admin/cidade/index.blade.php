            ...
            <div class="card">
                ...
                <div class="card-body ">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-black-50" id="exampleModalLabel">Adicionar Cidade
                                    </h5>
                                ...
                                <form class="form-controll" method="POST"
                                    action="{{route('admin.cidade.store')}}">
                                    @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($cidade as $dado)
                            <tr>
                                <td>{{$dado->nome}}</td>
                                <td>{{$dado->nomeEstado}}</td>
                                <td class="">
                                    @if ($dado->id)
                                    <form action="{{ route('admin.cidade.destroy', $dado->id) }}" method="post">
                                        @csrf
                                        @method('delete')
                                        <a href="{{route('admin.cidade.edit', $dado->id)}}" class="btn btn-md bg-success text-white">
                                            <i class="fa fa-pen"></i>
                                        </a>
