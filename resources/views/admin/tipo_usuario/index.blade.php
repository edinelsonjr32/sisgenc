                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-black-50" id="exampleModalLabel">Adicionar Tipo Usuário
                                    </h5>
                                ...
                                <form class="form-controll" method="POST"
                                    action="{{route('admin.tipo_usuario.store')}}">
                                    @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    @if ($dado->id)
                                    <form action="{{ route('admin.tipo_usuario.destroy', $dado) }}" method="post">
                                        @csrf
                                        @method('delete')
                                        <a href="{{route('admin.tipo_usuario.edit', $dado)}}" class="btn btn-md bg-success text-white">
                                            <i class="fa fa-pen"></i>
                                        </a>
