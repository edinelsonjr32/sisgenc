    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body ">
                    <a  class="btn btn-primary col-md-2 offset-10" href="{{route('admin.estado.index')}}">
                        Voltar
                    </a>
                    <br><br>

                    <form class="form-controll" method="POST" action="{{route('admin.estado.update', $estado->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="name" class="form-control" id="nome" aria-describedby="nome"
                                    placeholder="Adicione o nome do Tipo" name="nome" value="{{$estado->nome}}">
